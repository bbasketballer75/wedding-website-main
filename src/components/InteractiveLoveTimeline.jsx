        ...
        <div className="milestones-container">
          {milestones.map((milestone, index) => (
            <button
              ...
              className={`milestone-item milestone-button ${index === activeIndex ? 'active' : ''} ${
              ...
              aria-describedby={`milestone-content-${index}`}
              aria-label={`Show details for milestone: ${milestone.title} - ${milestone.date}`}
            >
              <div
