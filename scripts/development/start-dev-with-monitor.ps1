...
if (-not $frontendRunning) {
    ...
    Start-Process powershell -ArgumentList '-NoProfile', '-Command', "Set-Location '$PSScriptRoot'; npm run dev" -WindowStyle Minimized
...
if (-not $backendRunning) {
    ...
    Start-Process powershell -ArgumentList '-NoProfile', '-Command', "Set-Location '$PSScriptRoot\\backend'; npm start" -WindowStyle Minimized
    Start-Sleep -Seconds 3
} else {
