...
import '../styles/PhotoGalleryEnhanced.css';

const PhotoGalleryEnhanced = ({ refreshKey }) => {
  ...
  if (isLoading && media.length === 0) {
    return (
      <div className="photo-gallery-enhanced" aria-live="polite">
  ...
  if (error && media.length === 0) {
    return (
      <div className="photo-gallery-enhanced" role="alert" aria-live="assertive">
  ...
  return (
    <main className="photo-gallery-enhanced" aria-label="Wedding photo gallery">
      <div className="gallery-header">
        <h2>Our Wedding Album</h2>
        {media.length > 0 && (
...
PhotoGalleryEnhanced.propTypes = {
  refreshKey: PropTypes.number,
};

PhotoGalleryEnhanced.defaultProps = {
  refreshKey: 0,
};
